...
;;                  advanced-cons advanced-list*))
  ...
  (require (for-syntax lang/private/teachhelp
                       lang/private/rewrite-error-message
                       lang/private/teach-shared
                       lang/private/rewrite-error-message.rkt
                       syntax/kerncase
                       syntax/stx
                       syntax/struct
                       syntax/context
                       mzlib/include
                       scheme/list
                       (rename-in racket/base [racket:define-struct define-struct])
                       (only racket/base syntax->datum datum->syntax)
                       (rename-in racket/base [kw-app #%app])
                       racket/struct-info
  ...
  ; (require (rename-in "teachprims.rkt" [the-cons advanced-cons]))
