...
(function() {
    ...
    var resourceStructType = 
        MACHINE.modules['whalesong/resource/structs.rkt'].getExternalExports().get('struct:resource');

    var eventStructType = 
        MACHINE.modules['whalesong/web-world/event.rkt'].getExternalExports().get('struct:event');
